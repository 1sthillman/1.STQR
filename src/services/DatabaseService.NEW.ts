...
class DatabaseService {
  ...
  async updateProduct(product: Product): Promise<void> {
    await this.runExecute(
      ...
      [product.name, product.price, product.category, product.stock, product.image || null, product.description || null, product.id]
    );
  }
  ...
  async addToCart(item: CartItem): Promise<void> {
    await this.runExecute(
      'INSERT OR REPLACE INTO cart (id, name, price, quantity, barcode, image) VALUES (?, ?, ?, ?, ?, ?)',
